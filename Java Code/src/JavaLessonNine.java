...
public class JavaLessonNine {
    public static void main(String[]args){
        ...
        int[] numsToShort= new int[10];
        for(int i=0;i<10;i++){
            numsToShort[i] = (int)(Math.random()*100);
        }

        Arrays.sort(numsToShort);
        System.out.println(Arrays.toString(numsToShort));

        int whereIs50 = Arrays.binarySearch(numsToShort,50);
